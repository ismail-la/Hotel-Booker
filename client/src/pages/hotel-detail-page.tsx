              ...
              <div className="flex items-center mb-2">
                <div className="flex text-yellow-400 mr-2">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className={`h-4 w-4 ${i < (hotel?.rating || 0) ? "fill-current" : ""}`}
                    />
                  ))}
                </div>
          ...
          <div className="mb-10">
            <Tabs defaultValue="overview">
              ...
              <TabsContent value="overview" className="py-6">
                ...
                <h3 className="font-heading font-semibold text-lg mt-8 mb-4">
                  Popular Amenities
                </h3>
              ...
              <TabsContent value="location" className="py-6">
                ...
                <p className="text-neutral-600 mb-6">
                  {hotel.name} is located at {hotel.location}. The area is known
                  for its excellent access to local attractions.
                </p>
              ...
              <TabsContent value="reviews" className="py-6">
                ...
                <div className="bg-neutral-100 p-6 rounded-lg mb-6">
                    ...
                    <div>
                      <div className="flex text-yellow-400 mb-1">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            className={`h-5 w-5 ${i < hotel.rating ? "fill-current" : ""}`}
                          />
                        ))}
                      </div>
                  ...
                  <p className="text-neutral-600">
                    Guests love this hotel for its excellent location, friendly
